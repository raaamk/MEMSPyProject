...
# Alle Uebertragungsfunktionen ausgeben lassen
print(G_pt1_tf)
print(G_pt2a_tf)
print(G_pt2d_tf)
print(G_I_tf)

# Pol- und Nullstellen der Uebertragungsfunktionen ausgeben lassen
...
# Wenn ALLE realen Polstellen der Uebertragungsfunktion G_pt2a negativ sind, "Stabil!" ausgeben lassen
...
# Sprungsantwort der einzelnen Uebertragungsfuntkionen erstellen
